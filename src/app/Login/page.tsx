      ...
      <section className="w-full flex flex-col justify-center items-center">
        <div className="flex flex-col justify-center items-center my-[50px] w-full ">
          ...
          <div className="flex flex-col w-[30%] mx-auto items-center justify-center">
            ...
            <input
              className="rounded-l p-3 flex-1 border border-black w-[70%]"
              id="email"
              type="email"
            ...
            <div className="w-[70%] rounded-md bg-black p-3 text-white text-[25px] font-text text-center" onClick={handleLogin}>
              Sign In
            </div>
          </div>
        </div>
